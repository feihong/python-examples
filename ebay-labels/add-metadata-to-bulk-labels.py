...
chunk = '12346789 '
# chunk = 'MMMMMMMM '
domestic_packing = textwrap.fill('M' * 2 * 27, 27)
foreign_packing = textwrap.fill('M' * 5 * 21, 21)
domestic_notes = textwrap.fill('M' * 3 * 73, 73)
foreign_notes = textwrap.fill('M' * 3 * 79, 79)
center_line = '-  ' * 30
...
for i, page in enumerate(pages[:5], 1):
    add_message(page, content=domestic_packing, translate=(244, 316))
    add_message(page, content=domestic_notes, translate=(100, 347))
    add_message(page, content=center_line, translate=(45, 397))
    add_message(page, content=domestic_packing, translate=(244, 713))
...
page6 = pages[5]
add_message(page6, content=domestic_packing, translate=(244, 316))
writer.addPage(page6)

page7 = pages[6]
add_message(page7, content=foreign_packing, translate=(537, 143), rotate=-90)
